  ...
  return (
    <div data-aos="fade-up" className="text-center mx-auto">
      <div className=" mt-5">
        ...
        <p className=" text-4xl">A few words about</p>
        <img
        ...
        <div>
          <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
              ...
              <h1 className="lg:text-4xl font-bold leading-none text-center sm:text-2xl">
              ...
              <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
                  <img
                    ...
                    src="https://i.ibb.co/jfM9PZk/alexander-hipp-i-EEBWg-Y-6l-A-unsplash.jpg"
                  />
                ...
                <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
                  <img
                    alt=""
                    className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500"
                    src="https://i.ibb.co/LSVx9ht/istockphoto-1317804578-612x612.jpg"
                  />
                  <div className="flex-1 my-4">
                    <p className="text-xl font-semibold leading-snug">Olivia</p>
